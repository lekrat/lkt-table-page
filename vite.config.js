...
export default {
    ...
    build: {
        lib: {
            entry: `${ src }/index.ts`,
            name: 'LktTablePage',
            fileName: (format) => `lkt-table-page.${ format }.js`
        },
        outDir,
        minify: true,
        rollupOptions: {
            external: [ 'vue', 'lkt-tools', 'lkt-events', 'lkt-button', 'lkt-http-client', 'lkt-string-tools', 'axios', 'lkt-data-state', 'lkt-loader', 'lkt-table', 'lkt-paginator' ],
            output: {
                globals: {
                    vue: 'Vue',
                    axios: 'axios',
